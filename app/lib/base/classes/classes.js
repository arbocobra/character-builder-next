...
export class Barbarian extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: ['Animal Handling', 'Athletics', 'Intimidation', 'Survival'], count: 2, title: 'Select 2 skills' };
...
export class Bard extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: Skills, count: 3, title: 'Select 3 skills' };
...
export class Cleric extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: ['History', 'Insight', 'Medicine', 'Persuasion', 'Religion'], count: 2, title: 'Select 2 skills' };
...
export class Druid extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: ['Arcana', 'Animal Handling', 'Insight', 'Medicine', 'Nature', 'Perception', 'Religion', 'Survival'], count: 2, title: 'Select 2 skills' };
      this.items.armour = ['leather armour']
...
export class Fighter extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.weapons = ['Simple Weapons', 'Martial Weapons'];
      this.proficiencies.selectFromList.skills = { list: ['Acrobatics', 'Animal Handling', 'Athletics', 'History', 'Insight', 'Intimidation', 'Perception', 'Survival'], count: 2, title: 'Select 2 skills' };
...
export class Monk extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: ['Acrobatics', 'Athletics', 'History', 'Insight', 'Religion', 'Stealth'], count: 2, title: 'Select 2 skills' };
...
export class Paladin extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.weapons = ['Simple Weapons', 'Martial Weapons'];
      this.proficiencies.armour = ['All Armour', 'Shields'];
      this.proficiencies.selectFromList.skills = { list: ['Athletics', 'Insight', 'Intimidation', 'Medicine', 'Persuasion', 'Religion'], count: 2, title: 'Select 2 skills' };
...
export class Ranger extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.armour = ['Light Armour', 'Medium Armour', 'Shields'];
      this.proficiencies.weapons = ['Simple Weapons', 'Martial Weapons'];
      this.proficiencies.selectFromList.skills = { list: ['Animal Handling', 'Athletics', 'Insight', 'Investigation', 'Nature', 'Perception', 'Stealth', 'Survival'], count: 3, title: 'Select 3 skills' };
...
export class Rogue extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.armour = ['Light Armour'];
      this.proficiencies.selectFromList.skills = { list: ['Acrobatics', 'Athletics', 'Deception', 'Insight', 'Intimidation', 'Investigaion', 'Performance', 'Perception', 'Persuasion', 'Sleight of Hand', 'Stealth'], count: 4, title: 'Select 4 skills' };
...
export class Sorcerer extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.selectFromList.skills = { list: ['Arcana', 'Deception', 'Insight', 'Intimidation', 'Persuasion', 'Religion'], count: 2, title: 'Select 2 skills' };
      this.items.weapons = ['2 Daggers'];
...
export class Warlock extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.armour = ['Light Armour'];
      this.proficiencies.weapons = ['Simple Weapons'];
      this.proficiencies.selectFromList.skills = { list: ['Arcana', 'Deception', 'History', 'Intimidation', 'Investigation', 'Nature', 'Religion'], count: 2, title: 'Select 2 skills' };
      this.items.weapons = ['2 Daggers'];
      this.items.armour = ['Light Armour'];
...
export class Wizard extends BaseClass {
   constructor(level) {
      ...
      this.proficiencies.savingThrows = ['Intelligence', 'Wisdom'];
      this.proficiencies.weapons = ['Dagger, Dart, Sling, Quarterstaff, Light Crossbow'];
      this.proficiencies.selectFromList.skills = { list: ['Arcana', 'History', 'Insight', 'Investigation', 'Medicine', 'Religion'], count: 2, title: 'Select 2 skills' };
