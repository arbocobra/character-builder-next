import {featureFunctions} from '@/lib/base/classes/feature-functions';
const spellCasting = {
   bard: [
   ...
   [
      ...
      "When you gain a level in this class, you can choose one of the ranger spells you know and replace it with another spell from the ranger spell list, which also must be of a level for which you have spell slots.",
...
export const features = {
   barbarian: [
      ...
      { name: 'Unarmoured Defense', level: 1, apply: featureFunctions.barbUnarmouredDefence, // applied
      ...
      { name: 'Fast Movement', level: 5, apply: featureFunctions.fastMovement, // applied
      ...
      { name: 'Brutal Critical', level: 9, //* special
   ...
   bard: [
      ...
      { name: 'Bardic Inspiration', level: 1, //* special
      ...
      { name: 'Jack Of All Trades', level: 2, //TODO Apply
      ...
      { name: 'Song Of Rest', level: 2, //* special
      ...
      { name: 'Expertise', level: 3, //* special
      ...
      { name: 'Magical Secrets', level: 10, //* special
   ...
   cleric: [
      ...
      { name: 'Channel Divinity', level: 2, //* special
      ...
      { name: 'Destroy Undead', level: 5, //* special
   ...
   druid: [
      ...
      { name: 'Druidic', level: 1, apply: featureFunctions.druidic, // applied
      ...
      { name: 'Wild Shape', level: 2, //* special
   ...
   fighter: [
      { name: 'Fighting Style', level: 1, apply: featureFunctions.fighterFightingStyle,  // applied
      ...
      { name: 'Second Wind', level: 1, //* special
         description: "You have a limited well of stamina that you can draw on to protect yourself from harm. On your turn, you can use a bonus action to regain hit points equal to 1d10 + your fighter level. Once you use this feature, you must finish a short or long rest before you can use it again." 
      },
      { name: 'Action Surge', level: 2, //* special
      ...
      { name: 'Extra Attack', level: 5, //* special
      ...
      { name: 'Indomitable', level: 9, //* special
   ...
   monk: [
      { name: 'Unarmored Defense', level: 1, apply: featureFunctions.monkFightingStyle,  // applied
         description: "Beginning at 1st level, while you are wearing no armor and not wielding a shield, your AC equals 10 + your Dexterity modifier + your Wisdom modifier." 
      },
      { name: 'Martial Arts', level: 1, //* special
      ...
      { name: 'Unarmored Movement', level: 2, //* special
      ...
      { name: 'Deflect Missiles', level: 3, //* special
      ...
      { name: 'Slow Fall', level: 4, //* special
   ...
   paladin: [
      ...
      { name: 'Lay On Hands', level: 1, //* special
      ...
      { name: 'Fighting Style', level: 2, //Todo: Apply
      ...
      { name: 'Aura Of Protection', level: 6, //* special
      ...
      { name: 'Aura Of Courage', level: 10, //* special
   ...
   ranger: [
      { name: 'Favored Enemy', level: 1, //* special
      ...
      { name: 'Natural Explorer', level: 1, //* special
   ...
   rogue: [
      { name: 'Expertise', level: 1, //* special
      ...
      { name: 'Sneak Attack', level: 1, //* special
      ...
      { name: 'Thieves\' Cant', level: 1, //Todo: Apply
      ...
      { name: 'Slippery Mind', level: 15, //Todo: Apply
   ...
   sorcerer: [
      {name: 'Spellcasting', level: 1, description: spellCasting.sorcerer.join('\n') },
      { name: 'Font Of Magic', level: 2, //* special
      ...
      { name: 'Metamagic', level: 3, //* special
   ...
   warlock: [
      { name: 'Pact Magic', level: 1, description: spellCasting.warlock.join('\n')  }, //* special
      { name: 'Eldritch Invocations', level: 2, //* special
      ...
      { name: 'Pact Boon', level: 3, //Todo: Apply
      ...
      { name: 'Mystic Arcanum', level: 11, //* special
   ...
   wizard: [
      { name: 'Spellcasting', level: 1, description: spellCasting.wizard.join('\n') },
      { name: 'Arcane Recovery', level: 1, //* special
...
export const subFeatures = {
   barbarian: {
      ...
      'totem warrior': [
         { name: 'Totem Spirit', level: 3, //Todo: Apply
         ...
         { name: 'Aspect Of The Best', level: 6, //Todo: Apply
         ...
         { name: 'Totemic Attunement', level: 14, //Todo: Apply
   ...
   bard: {
      lore: [
         { name: 'Bonus Proficiencies', level: 3,  //Todo: Apply
         ...
         { name: 'Additional Magical Secrets', level: 6,  //Todo: Apply
   ...
   cleric: {
      knowledge: [
         { name: 'Knowledge Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Blessings Of Knowledge', level: 1,  //Todo: Apply
         ...
         { name: 'Channel Divinity: Knowledge Of The Ages', level: 2,
         ...
         { name: 'Channel Divinity: Read Thoughts', level: 6,
      ...
      life: [
         { name: 'Life Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Bonus Proficiencies', level: 1,  //Todo: Apply
      ...
      light: [
         { name: 'Light Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Bonus Cantrip', level: 1,  //Todo: Apply - with spells
      ...
      trickery: [
         { name: 'Trickery Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Blessing Of The Trickster', level: 1,
         ...
         { name: 'Channel Divinity: Cloak Of Shadows', level: 6,
         ...
         { name: 'Improved Duplicity', level: 17,
      ...
      nature: [
         { name: 'Nature Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Acolyte Of Nature', level: 1, //Todo: Apply - with spells
         ...
         { name: 'Bonus Proficiency', level: 1, //Todo: Apply
         ...
         { name: 'Master Of Nature', level: 17,
      ...
      tempest: [
         { name: 'Tempest Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Bonus Proficiencies', level: 1, //Todo: Apply
            description: "At 1st level, you gain proficiency with martial weapons and heavy armor.",
         },
         { name: 'Wrath Of The Storm', level: 1,
         ...
         { name: 'Channel Divinity: Destructive Wrath', level: 2,
         ...
         { name: 'Thunderous Strike', level: 6,
      ...
      war: [
         { name: 'War Domain Spells', level: 1,   //Todo: Apply - with spells
            description: "Gain news spells at level 1, 3, 5, 7, 9"
         },
         { name: 'Bonus Proficiency', level: 1, //Todo: Apply
            description: "At 1st level, you gain proficiency with martial weapons and heavy armor.",
         ...
         { name: 'Channel Divinity: Guided Strike', level: 2,
   ...
   druid: {
      land: [
         { name: 'Bonus Cantrip', level: 2,  //Todo: Apply - with spells
         ...
         { name: 'Circle Spells', level: 3, //Todo: Apply - with spells
      ...
      moon: [
         ...
         { name: 'Circle Forms', level: 2, //Todo: Apply - with spells
   ...
   fighter: {
      'battle master': [
         { name: 'Combat Superiority', level: 3, //Todo: Apply
         ...
         { name: 'Student Of War', level: 3,  //Todo: Apply
         ...
         { name: 'Improved Combat Superiority', level: 10,  //Todo: Apply
      ...
      champion: [
         ...
         { name: 'Remarkable Athlete', level: 7,  //Todo: Apply
         ...
         { name: 'Additional Fighting Style', level: 10,  //Todo: Apply
      ...
      'eldritch knight': [ 
         { name: 'Spellcasting', level: 3, description: spellCasting['eldritch knight'].join('\n'),
         },
         { name: 'Weapon Bond', level: 3,
         ...
         { name: 'Improved War Magic', level: 18,
   ...
   monk: {
      'four elements': [
         { name: 'Disciple Of The Elements', level: 3, //Todo: Apply
   ...
   paladin: {
      ancients: [
         { name: 'Tenets Of The Ancients', level: 3,
            description: "The tenets of the Oath of the Ancients have been preserved for uncounted centuries. This oath emphasizes the principles of good above any concerns of law or chaos. Its four central principles are simple.\n\nKindle the Light. Through your acts of mercy, kindness, and forgiveness, kindle the light of hope in the world, beating back despair.\n\nShelter the Light. Where there is good, beauty, love, and laughter in the world, stand against the wickedness that would swallow it. Where life flourishes, stand against the forces that would render it barren.\n\nPreserve Your Own Light. Delight in song and laughter, in beauty and art. If you allow the light to die in your own heart, you can't preserve it in the world.\n\nBe the Light. Be a glorious beacon for all who live in despair. Let the light of your joy and courage shine forth in all your deeds.",
         },
         { name: 'Oath Spells', level: 3, //Todo: Apply - with spells
         ...
         { name: 'Undying Sentinel', level: 15,
      ...
      devotion: [
         { name: 'Tenets of Devotion', level: 3,
   ...
   ranger: {
      ...
      hunter: [
         { name: "Hunter's Prey", level: 3, //Todo: Apply
         ...
         { name: 'Defensive Tactics', level: 7, //Todo: Apply
         ...
         { name: 'Multiattack', level: 11, //Todo: Apply
         ...
         { name: "Superior Hunter's Defense", level: 15, //Todo: Apply
   ...
   rogue: {
      'arcane trickster': [
         { name: 'Spellcasting', level: 3, description: spellCasting['arcane trickster'].join('\n'),
         },
         { name: 'Mage Hand Legerdemain', level: 3,
         ...
         { name: 'Versatile Trickster', level: 13,
   ...
   sorcerer: {
      'draconic bloodline': [
         { name: 'Dragon Ancestor', level: 1, //Todo: Apply
         ...
         { name: 'Draconic Resilience', level: 1, //Todo: Apply
      ...
      'wild magic': [
         { name: 'Wild Magic Surge', level: 1,
            description: "Starting when you choose this origin at 1st level, your spellcasting can unleash surges of untamed magic. Once per turn, the DM can have you roll a d20 immediately after you cast a sorcerer spell of 1st level or higher. If you roll a 1, roll on the Wild Magic Surge table to create a magical effect. If that effect is a spell, it is too wild to be affected by your Metamagic, and if it normally requires concentration, it doesn't require concentration in this case; the spell lasts for its full duration.",
         },
         { name: 'Tides Of Chaos', level: 6,
   ...
   warlock: {
      archfey: [
         { name: 'Expanded Spell List', level: 1, //Todo: Apply - with spells
         ...
         { name: 'Beguiling Defense', level: 10,
   ...
   wizard: {
      ...
      transmutation: [
         { name: 'Transmutation Savant', level: 2,
         ...
         { name: "Transmuter's Stone", level: 6,
         ...
         { name: 'Shapechanger', level: 10, //Todo: Apply - with spells
         ...
         { name: 'Master Transmuter', level: 14,
      ...
      conjuration: [
         { name: 'Conjuration Savant', level: 2,
         ...
         { name: 'Benign Transportation', level: 6,
         ...
         { name: 'Focused Conjuration', level: 10,
      ...
      divination: [
         { name: 'Divination Savant', level: 2,
         ...
         { name: 'Expert Divination', level: 6,
         ...
         { name: 'The Third Eye', level: 10,
            description: "Starting at 10th level, you can use your action to increase your powers of perception. When you do so, choose one of the following benefits, which lasts until you are incapacitated or you take a short or long rest. You can't use the feature again until you finish a short or long rest.\n\nDarkvision. You gain darkvision out to a range of 60 feet.\n\nEthereal Sight. You can see into the Ethereal Plane within 60 feet of you.\n\nGreater Comprehension. You can read any language.\n\nSee Invisibility. You can see invisible creatures and objects within 10 feet of you that are within line of sight.",
         },
         { name: 'Greater Portent', level: 14,
      ...
      enchantment: [
         { name: 'Enchantment Savant', level: 2,
            description: "Beginning when you select this school at 2nd level, the gold and time you must spend to copy a Enchantment spell into your spellbook is halved.",
         },
         ...
         { name: 'Instinctive Charm', level: 6,
         ...
         { name: 'Split Enchantment', level: 10,
      ...
      evocation: [
         { name: 'Evocation Savant', level: 2,
            description: "Beginning when you select this school at 2nd level, the gold and time you must spend to copy a Evocation spell into your spellbook is halved.",
         },
         ...
         { name: 'Empowered Evocation', level: 10,
            description: "Beginning at 10th level, you can add your Intelligence modifier (minimum of +1) to one damage roll of any wizard evocation spell that you cast.",
         },
      ...
      illusion: [
         ...
         { name: 'Improved Minor Illusion', level: 2, //Todo: Apply - with spells
         ...
         { name: 'Malleable Illusions', level: 6,
         ...
         { name: 'Illusory Reality', level: 14,
      ...
      necromancy: [
         { name: 'Necromancy Savant', level: 2,
         ...
         { name: 'Inured To Undeath', level: 10,
